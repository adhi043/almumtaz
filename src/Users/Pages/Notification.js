            ...
            <View style={{ backgroundColor: Color.background, flex: 1 }} >
                <View style={{ padding: 20, paddingTop: 40 }}>
                    ...
                    <View style={{ marginVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 10, }}>
                        ...
                        <TouchableOpacity style={[tw`p-2`, { backgroundColor: sel === 'All' ? Color.background2 : Color.white, borderRadius: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', minWidth: 70, gap: 5, elevation: 5, borderColor: Color.white, borderWidth: 1 }]} onPress={() => {
                            setSel('All')
                        }}>
                            <Text style={{ color: sel === 'All' ? Color.white : Color.black, fontSize: FontSize.font1_size }}>All</Text>
                        </TouchableOpacity>


                        <TouchableOpacity style={[tw`p-2`, { backgroundColor: sel === 'Unread' ? Color.background2 : Color.white, borderRadius: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', minWidth: 70, gap: 5, elevation: 5, borderColor: Color.white, borderWidth: 1 }]} onPress={() => {
                            setSel('Unread')
                        }}>
                            <Text style={{ color: sel === 'Unread' ? Color.white : Color.black, fontSize: FontSize.font1_size }}>Unread</Text>
                        </TouchableOpacity>
                    ...
                    <ScrollView  showsVerticalScrollIndicator={false}>
                        ...
                        <TouchableOpacity style={{ padding: 10, backgroundColor: Color.colorwhite_100, borderRadius: 20, flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginTop: 10, marginBottom: 5 }}>
                            ...
                            <View style={{ width: '85%' }}>
                                ...
                                <Text style={{ color: Color.gray2, fontSize: FontSize.font1_size, alignSelf: 'flex-end' }}>10 Jan 2024 04:30 PM</Text>
                            </View>
                        ...
                        <TouchableOpacity style={{ padding: 10, backgroundColor: 'transparent', borderRadius: 20, flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginBottom: 5 }}>
                            <TouchableOpacity style={[tw`p-2`, { backgroundColor: Color.background2, borderRadius: 20, elevation: 5 }]}>
                                <CheckBadgeIcon size={25} color={Color.white} />
                            </TouchableOpacity>
                            <View style={{ width: '85%' }}>
