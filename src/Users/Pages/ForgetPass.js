      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1, backgroundColor: Color.white }}>
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          ...
          <View style={{ marginTop: 20, }}>
            <LottieView source={require('../../assets/16766-forget-password-animation.json')} autoPlay loop style={{ width: 200, height: 200 }} />
          </View>

          <View style={{ marginVertical: 20, justifyContent: 'center', alignItems: 'center', flexDirection: 'column', paddingHorizontal: 30 }}>
            <Text style={{ color: Color.black, fontSize: fontSize(FontSize.headline2_size), fontWeight: 'bold', }}>Forgot your Password?</Text>

            <Text style={{ color: Color.black, fontSize: fontSize(FontSize.font_size), fontWeight: '500', textAlign: 'center' }}>To retrieve your password, please provide your registered mobile number.</Text>
          </View>
          ...
          <View style={{ paddingHorizontal: 20, width: width, marginTop: 60 }}>
            <TouchableOpacity style={[tw`p-3`, { backgroundColor: Color.background, borderRadius: 10, flexDirection: 'row', width: '100%', justifyContent: 'center', alignItems: 'center', elevation: 5 }]} onPress={() => { navigation.navigate('ForgetPass1') }}>
