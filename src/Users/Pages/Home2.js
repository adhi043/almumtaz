    ...
    <>
      <ScrollView style={{ backgroundColor: Color.white }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ padding: 10, }}>
          ...
          <View style={{ marginTop: 10,marginBottom:190 }}>

            <View style={{ marginVertical: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text style={{ color: Color.black, fontSize: fontSize(FontSize.pxRegular_size), fontWeight: '500' }}>AC Services at home</Text>
            </View>
            ...
            {cat.map(i => {
              return (<>
                <View style={{ marginRight: 10, padding: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10, backgroundColor: Color.gray3, borderRadius: 30, paddingRight: 10, elevation: 5, marginBottom: 15,width:'100%' }}>

                  <View>
                    <Text style={{ color: Color.black, fontSize: fontSize(FontSize.pxRegular_size), fontWeight: 'bold' }}>AC Dismounting/Removal</Text>
                    <Text style={{ color: Color.black, fontSize: fontSize(FontSize.font2_size), fontWeight: '400' }}>Per AC (1 to 2.5 tons)</Text>
                    <Text style={{ color: Color.green1, fontSize: fontSize(FontSize.pxRegular_size), fontWeight: 'bold' }}>600 Per AC Fitting</Text>
                    <TouchableOpacity style={{ backgroundColor: Color.background, width: 120, paddingHorizontal: 10, borderRadius: 20, marginVertical: 10, padding: 8, justifyContent: 'center', alignItems: 'center', }} onPress={() => { setShow(true) }}>
                      <Text style={{ color: Color.white, fontSize: fontSize(FontSize.pxRegular_size), fontWeight: '400' }}>Book Now</Text>
                    </TouchableOpacity>
                  </View>
      ...
      <View style={{ position: 'absolute', bottom: '0%', paddingHorizontal: 10,backgroundColor:Color.white,paddingBottom:10 }}>
        ...
        <View style={{ marginRight: 10, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: Color.background, borderRadius: 15, paddingRight: 10, elevation: 5, marginBottom: 15, }}>
        ...
        <TouchableOpacity style={[tw`p-3`, { backgroundColor: Color.black, borderRadius: 10, flexDirection: 'row', width: '96%', justifyContent: 'center', alignItems: 'center' }]} onPress={()=>{navigation.navigate('Cart')}}>
